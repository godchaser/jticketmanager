...
public class TicketsView extends VerticalLayout implements View {
	...
	private void initEditor() {
		...
		TextField ticketIDField = new TextField(TicketsSQLContainer
				.getDbColumnsMap().get(TicketsSQLContainer.propertyIds.ID.toString()));
		...
		// COMBOBOXES
		selectCategory = new ComboBox(TicketsSQLContainer
				.getDbColumnsMap().get(TicketsSQLContainer.propertyIds.ticketCategory.toString()));
		...
		//selectCategory.select(TicketsSQLContainer.ticketCategories.FEATURE);
		...
		// TODO: have to manually updated certain comboBoxes and rest put in field groups
		//editorFields.bind(selectCategory, TicketsSQLContainer.propertyIds.ticketCategory.toString());
		
		selectStatus = new ComboBox(TicketsSQLContainer
				.getDbColumnsMap().get(TicketsSQLContainer.propertyIds.ticketStatus.toString()));
		...
		selectPriority = new ComboBox(TicketsSQLContainer
				.getDbColumnsMap().get(TicketsSQLContainer.propertyIds.ticketPriority.toString()));
		...
		TextField ticketAsigneeField = new TextField(TicketsSQLContainer
				.getDbColumnsMap().get(TicketsSQLContainer.propertyIds.ticketAssignee.toString()));
		...
		TextField ticketUpdatedField = new TextField(TicketsSQLContainer
				.getDbColumnsMap().get(TicketsSQLContainer.propertyIds.ticketUpdate.toString()));
		...
		for (String fieldName : TicketsSQLContainer.getDbColumnsMap().keySet()) {
			String mappedFieldName = TicketsSQLContainer.getDbColumnsMap().get(
					fieldName);
			LOG.trace("adding fieldName to editor layout: " + mappedFieldName);
			ComboBox comboBox = new ComboBox();
			TextField field = new TextField(mappedFieldName);
			field.setId(mappedFieldName);
